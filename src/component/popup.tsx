...
const Popup = (props: PopupProps) => {
    ...
    return (
        ...
        >
            {children}
            <h2 className='text-gray-100 mx-auto text-center mt-[5%] text-[1.2rem]'>
                {textContent}
            </h2>
            <span
                onClick={() => setState(false)}
                className="absolute aspect-square bg-red-500 lg:w-[1.5rem] md:w-[1.5rem] w-[2rem] rounded-full text-transparent hover:text-gray-700 flex justify-center items-center cursor-pointer bottom-[6%] right-[8%] lg:top-[6%] lg:left-[6%] md:top-[6%] md:left-[6%]">
