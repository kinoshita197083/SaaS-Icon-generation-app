...
const BannerCard = (props: BannerCardProps) => {
    ...
    const defaultStyle = "relative rounded-[25px] lg:h-[16rem] lg:w-[16rem] md:w-[45%] h-[auto] w-[70%] aspect-square cursor-pointer mx-auto hover:scale-[1.02] transition-all";
