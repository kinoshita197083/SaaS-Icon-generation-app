    ...
    return (
        <div className='min-h-full px-[8%] lg:px-[18%] lg:py-[5%]'>
            ...
            <section className='bg-[url(/scenery.jpg)] bg-cover bg-no-repeat bg-center rounded-[25px]'>
                <div className='container-s blur-dark flex flex-col rounded-[inherit]'>
            ...
            <section className='bg-gray-400 h-[25rem] my-[5%] lg:my-0 lg:w-full lg:h-[35rem] rounded-[25px] overflow-hidden'>
                <Carousel
