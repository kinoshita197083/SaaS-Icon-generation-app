...
const Generate: NextPage = () => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      setTimeout(
        () => setError((prev) => ({ ...prev, activate: false, message: "" })),
        5000
      );
  ...
  return (
    <>
      ...
      <PageTemplate>
        <form
          className="mt-[5%] md:mt-[3%] lg:mt-[1%] lg:w-[55%]"
        ...
        >
          ...
          <section className="mb-[8%] ">
            ...
            <p className="text-[0.8rem] text-indigo-400">
              * AI can struggle with recognizing certain colors
            </p>
            <div>
              ...
              {colorOption === "ColorPicker" && (
                <div className="flex h-[4rem] w-full items-center justify-center lg:w-[40%]">
                  <input
                    type="color"
                    ...
                    onChange={(e) =>
                      updateForm(
                        "color",
                        GetColorName((e.target as HTMLInputElement).value)
                      )
                    }
                  />
                </div>
                  ...
                  {colors.map((color) => {
                    ...
                    return (
                      <button
                        ...
                        className={[
                          color.tailwind,
                          "mt-[1.5%] h-[2rem] w-[2rem] cursor-pointer rounded-full duration-100 hover:scale-[1.2]",
                        ].join(" ")}
                        onClick={(e) =>
                          updateForm(
                            "color",
                        ...
                        style={{
                          border: target ? "2px solid white" : "",
                          transform: target ? "scale(1.2)" : "",
                        }}
                      />
                    );
                  })}
          ...
          <section className="">
            <FormLabel label="Select a style" />
            ...
            {styleOption === "icon" && (
              <div className="mb-[8%] mt-[2%] flex flex-wrap gap-[3%]">
          ...
          {styleOption === "icon" && (
            <section className="my-[5%]">
              <FormLabel label="Face orientation" />
              <Select
                ...
                onChange={(e: SelectChangeEvent) =>
                  updateForm("orientation", e.target.value)
                }
                style={{ color: "white" }}
              >
          ...
          <section>
            <FormLabel label="Number of images" />
          ...
          {isLoggedIn ? (
            <Button disabled={formData.loading}>
            ...
            <>
              ...
              <Button
                ...
                className="rounded bg-gradient-to-r from-sky-500 to-indigo-500 p-[2%] px-[3%] text-gray-100"
              >
                Get Started
              </Button>
            </>
          ...
          {error.activate && (
            <div className="left-[50%] flex w-full items-center justify-center lg:absolute lg:translate-x-[-50%]">
        ...
        <section className="relative mx-auto my-[8%] flex aspect-square h-[auto] w-[100%] rounded-[15px] bg-gray-700 lg:m-auto lg:w-[45%]">
          {formData.loading ? (
            <>
              <Skeleton
                sx={{ bgcolor: "grey.900" }}
            ...
            <Carousel images={formData.imageURLs} downloadable />
          )}
        </section>
